...
local on_attach = function(client, bufnr)
  ...
  keymap.set("n", "gpt", "<cmd>Lspsaga peek_type_definition<CR>", opts) -- see definition and make edits in window
  ...
  keymap.set("n", "<leader>q", "<cmd>lspsaga peekview_close<CR>", opts)
  --keymap.set("n", "gi", "<cmd>lua vim.lsp.buf.implementation()<CR>", opts) -- go to implementation
  -- Call hierarchy
