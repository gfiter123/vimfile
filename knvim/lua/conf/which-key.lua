...
local mappings = {
    ...
    b = { "<Cmd>BufferOrderByBufferNumber<CR>","BufferOrder" },
	},
	...
	s = {
		...
		t = { "<cmd>Telescope grep_string theme=ivy<CR>", "Find Current Text" },
    ...
    b = { "\"fyiw<cmd>Telescope  current_buffer_fuzzy_find theme=ivy<CR>","search buffer" },
		P = { "<cmd>Telescope projects<CR>", "Projects" },
    p = { "<cmd>SessionManager load_session<cr>", "Session" },
    h = { "<cmd>Telescope  search_history theme=ivy<CR>","search// history" },
 	},
