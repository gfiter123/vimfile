...
local defaults = {
	...
	normal_mode = {
		...
		["<leader>dui"] = ":lua require'dapui'.eval()<CR>",
		...
		["f"] = ":HopChar1<CR>",
		--每隔5个字符用一个标识
		["<leader><leader>i"] = "<cmd>lua require('hop').hint_patterns({multi_windows = true}, '.....')<cr>",
		...
		--在窗口下方打开终端
		["<leader>t"] = ":ToggleTerm size=20 direction=float<CR>",
	},
