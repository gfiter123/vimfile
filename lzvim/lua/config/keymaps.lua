...
vim.keymap.set("v", "<leader>hh", ":<c-u>HSHighlight 1<CR>", { desc = "HSHighlight", noremap = true, silent = true })
vim.keymap.set("v", "<leader>hr", ":<c-u>HSRmHighlight 1<CR>", { desc = "HSHighlight", noremap = true, silent = true })
